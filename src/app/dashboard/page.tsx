...
export default function DashboardPage() {
  ...
  const confirmPayment = async (receivedAmount: number, shouldPrintReceipt: boolean) => {
    ...
    try {
      ...
      if (shouldPrintReceipt && receipt) printBill(selectedTable, tableOrders, { ...settings, locale, footer: settings.receipt.footer, receipt: settings.receipt }, { received: receipt.receivedAmount ?? receivedAmount, change: receipt.changeAmount }, receiptWindow, true, { number: receipt.receiptNumber, issuedAt: receipt.receiptIssuedAt });
      closePayment();
