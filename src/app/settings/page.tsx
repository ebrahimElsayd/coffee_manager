...
const settingsTextAr: Record<string, string> = {
  ...
  "Cafe branch address": "عنوان فرع الكافيه", "Account Email": "البريد الإلكتروني للحساب",
